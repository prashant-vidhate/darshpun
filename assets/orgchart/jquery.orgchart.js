...
! function(e) {
    ...
    t.prototype = {
        ...
        createNode: function(i) {
            ...
            e.nodeTemplate ? n.append(e.nodeTemplate(i)) : n.append('<div class="title">' + i[e.nodeTitle] + "</div>").append(void 0 !== e.nodeContent ? '<div class="content" style="max-height: 20px !important; min-height: 20px; padding: 0px !important;">' + (i[e.nodeContent] || "") + "</div>" : "");
            var s = v.extend({}, i);
