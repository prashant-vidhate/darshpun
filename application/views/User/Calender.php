...
<head>
  ...
  <!-- fullCalendar 2.2.5-->
  <link rel="stylesheet" href="<?php echo base_url()?>assets/User/plugins/fullcalendar/fullcalendar.min.css">
  <link rel="stylesheet" href="<?php echo base_url()?>assets/User/plugins/fullcalendar/fullcalendar.print.css" media="print">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url()?>User/UserDashboard"><i class="fa fa-dashboard"></i> Home</a></li>
...
<script src="<?php echo base_url()?>assets/User/plugins/fullcalendar/fullcalendar.min.js"></script>
